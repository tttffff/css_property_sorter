...
Gem::Specification.new do |spec|
  ...
  spec.homepage = CssPropertySorter::REPO
  spec.license = "MIT"
  spec.required_ruby_version = ">= 3.0.0"

  spec.metadata["homepage_uri"] = CssPropertySorter::REPO
  spec.metadata["source_code_uri"] = CssPropertySorter::REPO

  gemspec = File.basename(__FILE__)
  spec.files = IO.popen(%w[git ls-files -z], chdir: __dir__, err: IO::NULL) do |ls|
    ls.readlines("\x0", chomp: true).reject do |file_path|
      (file_path == gemspec) || file_path.start_with?(*%w[.git Gemfile])
    end
  end
